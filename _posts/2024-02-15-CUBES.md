...
The last couple posts were post graduation work I completed. But, this project was completed during the first half of the semester for COMP 490 - Senior Design and Development it was a solo project. It taught me a lot about software development and being able to use an API in conjunction with Python code and SQlite databases.
